...
public class PlaceGearCommand extends Command {
	...
	protected void execute() {
		...
		selectedAutonomousGearPlacementLocation = autonomousGearPlacementOptions.PLACE_GEAR_LEFT_AIRSHIP;
		switch (selectedAutonomousGearPlacementLocation) {
			...
			//	m.pushProfile(TrapezoidalProfile.getTrapezoidZero(76.0/6.0/Math.PI, 70, 3*Math.PI/2, 0), true, true); 
				...
				m.pushTurn((Math.PI/2 -dstPosition.theta), false, false); //OG
		...
		//		Timer.delay(10);
				...
				System.out.println("Entering 20 sec delay");
				Timer.delay(20);
